...
const Tumanlar = ({info, tumanHandler}) => {
    ...
    return (
        <div onClick={()=> tumanHandler(info.tuman_id)} className={color} style={{display: "flex",cursor: "pointer", justifyContent: "space-between", alignItems: "center",padding: "0 5px",boxSizing: "border-box",border: "2px solid white", height: "60px"}}>
